/**
 * Injected into a single-pass Vitest run by `testpick map`.
 *
 ...
 *
 * Results are appended (one JSON object per test file) to TESTPICK_OUT.
 */
...
if (!g.__testpick_session) {
  ...
  g.__testpick_prev = new Map(); // script url -> cumulative count
